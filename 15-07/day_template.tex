...
\begin{minipage}[t][\textheight][t]{0.33\textwidth}
 ...
 : &\hfill 07 h 09 \\ 
                            Coucher soleil \includegraphics[width=8px,height=8px]{../../Pictos/lune_OffWhite.png} : &\hfill 21 h 20 \\ 
                            \\
                            Abris replis : &  \\
                                    & • Arradon \\
                                    & • Île au Moines \\
                ...
                \begin{minipage}[t][0.4\textheight][t]{\textwidth}
                    ...
                    \input{15-07/marees/maree_navalo}
                    \input{15-07/marees/maree_vannes}
                \end{minipage}%
            \end{center}       
        }      
    }
