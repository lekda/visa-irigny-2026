        ...
        \parbox[c][\textheight][c]{\textwidth}{ 
            ...
            \begin{center}
                \begin{minipage}[t][0.6\textheight][c]{0.8\textwidth}
                    ...
                    \begin{center}
                        \begin{tabular}{@{} l @{\hspace{0.5cm}} l @{}}
                            ...
                            Lever soleil \includegraphics[width=8px,height=8px]{../../Pictos/soleil_OffWhite.png} : &\hfill 06 h 31 \\ 
                            Coucher soleil \includegraphics[width=8px,height=8px]{../../Pictos/lune_OffWhite.png} : &\hfill 21 h 58 \\ 
                            \\
                            Abris replis : &  \\
                                    & •  \\
                                    & •  \\
                ...
                \begin{minipage}[t][0.4\textheight][t]{\textwidth}
                    \input{18-07/marees/maree_pornichet}                
                    \input{18-07/marees/maree_herbaudiere}
                \end{minipage}%
            \end{center}       
        }      
    }
...
\begin{minipage}[c][\textheight][t]{0.50\textwidth}
    ...
    {\large \textbf{Traversée}}\\
        \begin{itemize}
                ...
                \item Vigilance au courant en entrée de Loire et au flux vers et en sortie de Saint-Nazaire ainsi qu'aux nombreux bateaux de transport
        \end{itemize}
